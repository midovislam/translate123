...
export async function POST(req: NextRequest) {
  ...
  // Step 2: Map detected language to pair
  // Whisper returns full language names (lowercase), match against our codes
...
// Map ISO 639-1 codes to full language names (what Whisper returns)
